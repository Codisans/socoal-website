...
const variants = {
  primary: clsx(
    ...
    'rounded-full border border-transparent bg-dark-blue shadow-md',
    'text-base font-medium whitespace-nowrap text-white',
    'data-disabled:bg-dark-blue data-disabled:opacity-40 data-hover:bg-blue',
  ),
  secondary: clsx(
    'relative inline-flex items-center justify-center px-4 py-[calc(--spacing(2)-1px)]',
    'rounded-full border border-transparent bg-white/15 shadow-md ring-1 ring-blue/15',
    'after:absolute after:inset-0 after:rounded-full after:shadow-[inset_0_0_2px_1px_#ffffff4d]',
    'text-base font-medium whitespace-nowrap text-dark-blue',
  ...
  outline: clsx(
    ...
    'text-sm font-medium whitespace-nowrap text-dark-blue',
